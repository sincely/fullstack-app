...
// 导入控制层（模块化结构）
import User from '#controllers/common/userController.js'
import { validateBody, validateQuery } from '#middleware/validationMiddleware.js'
import authMiddleware from '#middleware/authenticate.js'
import userAuthController from '#controllers/common/authController.js'
import { errorControllerWrapper } from '#utils/errorHandler.js'
import { LoginBodySchema, FindUserNameBodySchema, RegisterBodySchema } from '#schemas/common/userEntitySchema.js'
import authenticate from '#middleware/authenticate.js'
import { AuthLoginBodySchema, RefreshTokenBodySchema } from '#schemas/common/userAuthSchema.js'
