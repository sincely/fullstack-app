...
-- ----------------------------
BEGIN;
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (1, '/about', 'about', 'layout.base$view.about', NULL, '{\"icon\": \"fluent:book-information-24-regular\", \"order\": 10, \"title\": \"关于\"}', NULL);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (2, '/function', 'function', 'layout.base', NULL, '{\"icon\": \"icon-park-outline:all-application\", \"order\": 6, \"title\": \"系统功能\"}', NULL);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (3, '/function/hide-child', 'function_hide-child', NULL, '/function/hide-child/one', '{\"icon\": \"material-symbols:filter-list-off\", \"order\": 2, \"title\": \"隐藏子菜单\"}', 2);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (4, '/function/hide-child/one', 'function_hide-child_one', 'view.function_hide-child_one', NULL, '{\"icon\": \"material-symbols:filter-list-off\", \"title\": \"子菜单一\", \"activeMenu\": \"function_hide-child\", \"hideInMenu\": true}', 3);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (5, '/function/hide-child/three', 'function_hide-child_three', 'view.function_hide-child_three', NULL, '{\"title\": \"子菜单三\", \"activeMenu\": \"function_hide-child\", \"hideInMenu\": true}', 3);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (6, '/function/hide-child/two', 'function_hide-child_two', 'view.function_hide-child_two', NULL, '{\"title\": \"子菜单二\", \"activeMenu\": \"function_hide-child\", \"hideInMenu\": true}', 3);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (7, '/function/multi-tab', 'function_multi-tab', 'view.function_multi-tab', NULL, '{\"icon\": \"ic:round-tab\", \"title\": \"多标签页\", \"multiTab\": true, \"activeMenu\": \"function_tab\", \"hideInMenu\": true}', 2);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (8, '/function/request', 'function_request', 'view.function_request', NULL, '{\"icon\": \"carbon:network-overlay\", \"order\": 3, \"title\": \"请求示例\", \"buttons\": [{\"code\": \"request:get\", \"desc\": \"获取请求\"}, {\"code\": \"request:post\", \"desc\": \"提交请求\"}]}', 2);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (9, '/function/super-page', 'function_super-page', 'view.function_super-page', NULL, '{\"icon\": \"ic:round-supervisor-account\", \"order\": 5, \"title\": \"超级管理员页\"}', 2);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (10, '/function/tab', 'function_tab', 'view.function_tab', NULL, '{\"icon\": \"ic:round-tab\", \"order\": 1, \"title\": \"标签页\", \"buttons\": [{\"code\": \"tab:add\", \"desc\": \"新增标签页\"}, {\"code\": \"tab:update\", \"desc\": \"修改标签页\"}, {\"code\": \"tab:remove\", \"desc\": \"删除标签页\"}]}', 2);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (11, '/function/toggle-auth', 'function_toggle-auth', 'view.function_toggle-auth', NULL, '{\"icon\": \"ic:round-construction\", \"order\": 4, \"title\": \"切换权限\"}', 2);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (12, '/home', 'home', 'layout.base$view.home', NULL, '{\"icon\": \"mdi:monitor-dashboard\", \"order\": 1, \"title\": \"首页\"}', NULL);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (13, '/manage', 'manage', 'layout.base', NULL, '{\"icon\": \"carbon:cloud-service-management\", \"order\": 9, \"title\": \"系统管理\"}', NULL);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (14, '/manage/menu', 'manage_menu', 'view.manage_menu', NULL, '{\"icon\": \"material-symbols:route\", \"order\": 3, \"title\": \"菜单管理\", \"buttons\": [{\"code\": \"menu:add\", \"desc\": \"新增菜单\"}, {\"code\": \"menu:edit\", \"desc\": \"编辑菜单\"}, {\"code\": \"menu:delete\", \"desc\": \"删除菜单\"}], \"keepAlive\": true}', 13);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (15, '/manage/role', 'manage_role', 'view.manage_role', NULL, '{\"icon\": \"carbon:user-role\", \"order\": 2, \"title\": \"角色管理\", \"buttons\": [{\"code\": \"role:add\", \"desc\": \"新增角色\"}, {\"code\": \"role:edit\", \"desc\": \"编辑角色\"}, {\"code\": \"role:delete\", \"desc\": \"删除角色\"}, {\"code\": \"role:menu\", \"desc\": \"菜单权限\"}, {\"code\": \"role:button\", \"desc\": \"按钮权限\"}]}', 13);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (16, '/manage/user', 'manage_user', 'view.manage_user', NULL, '{\"icon\": \"ic:round-manage-accounts\", \"order\": 1, \"title\": \"用户管理\", \"buttons\": [{\"code\": \"user:add\", \"desc\": \"新增用户\"}, {\"code\": \"user:edit\", \"desc\": \"编辑用户\"}, {\"code\": \"user:delete\", \"desc\": \"删除用户\"}]}', 13);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (17, '/manage/user-detail/:id', 'manage_user-detail', 'view.manage_user-detail', NULL, '{\"title\": \"用户详情\", \"activeMenu\": \"manage_user\", \"hideInMenu\": true}', 13);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (18, '/multi-menu', 'multi-menu', 'layout.base', NULL, '{\"order\": 8, \"title\": \"多级菜单\"}', NULL);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (19, '/multi-menu/first', 'multi-menu_first', NULL, NULL, '{\"order\": 1, \"title\": \"菜单一\"}', 18);
...
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (21, '/multi-menu/second', 'multi-menu_second', NULL, NULL, '{\"order\": 2, \"title\": \"菜单二\"}', 18);
