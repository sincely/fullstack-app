...
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (8, '/function/request', 'function_request', 'view.function_request', NULL, '{\"title\": \"请求示例\", \"icon\": \"carbon:network-overlay\", \"order\": 3}', 2);
...
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (10, '/function/tab', 'function_tab', 'view.function_tab', NULL, '{\"title\": \"标签页\", \"icon\": \"ic:round-tab\", \"order\": 1}', 2);
...
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (14, '/manage/menu', 'manage_menu', 'view.manage_menu', NULL, '{\"title\": \"菜单管理\", \"icon\": \"material-symbols:route\", \"order\": 3, \"keepAlive\": true}', 13);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (15, '/manage/role', 'manage_role', 'view.manage_role', NULL, '{\"title\": \"角色管理\", \"icon\": \"carbon:user-role\", \"order\": 2}', 13);
INSERT INTO `RouteAuth` (`id`, `path`, `name`, `component`, `redirect`, `meta`, `parent_id`) VALUES (16, '/manage/user', 'manage_user', 'view.manage_user', NULL, '{\"title\": \"用户管理\", \"icon\": \"ic:round-manage-accounts\", \"order\": 1}', 13);
