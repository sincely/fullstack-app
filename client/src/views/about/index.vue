...
<template>
  <a-space direction="vertical" :size="16">
    <a-card :title="'关于'" :bordered="false" size="small" class="card-wrapper">
      <p>
        {{
    ...
    <a-card :title="'项目信息'" :bordered="false" size="small" class="card-wrapper">
      <a-descriptions label-placement="left" bordered size="small" :column="{ xs: 1, sm: 2 }">
    ...
    <a-card :title="'生产依赖'" :bordered="false" size="small" class="card-wrapper">
      <a-descriptions label-placement="left" bordered size="small" :column="{ xs: 1, sm: 2 }">
    ...
    <a-card :title="'开发依赖'" :bordered="false" size="small" class="card-wrapper">
      <a-descriptions label-placement="left" bordered size="small" :column="{ xs: 1, sm: 2 }">
