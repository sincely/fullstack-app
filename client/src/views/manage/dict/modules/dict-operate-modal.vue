  ...
  <a-modal v-model:open="visible" :title="title" width="500px">
    <a-form ref="formRef" :model="model" :rules="rules">
      <a-form-item :label="'字典名称'" name="dictName">
        <a-input v-model:value="model.dictName" :placeholder="'请输入字典名称'" />
      </a-form-item>
      <a-form-item :label="'字典编码'" name="dictCode">
        <a-input v-model:value="model.dictCode" :placeholder="'请输入字典编码'" />
      </a-form-item>
      ...
      <a-form-item :label="'备注'" name="remark">
        <a-textarea v-model:value="model.remark" :placeholder="'请输入备注'" :rows="3" />
      </a-form-item>
    </a-form>
    <template #footer>
